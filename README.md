# [Transitions  Custom CSS transitions](https://svelte.dev/tutorial/custom-css-transitions)
...
- `easing` — a `p => t` easing function (see the chapter on [tweening](https://svelte.dev/tutorial/tweened))
